 ...
 * =====================================================
 */
var url = "https://www.schjcpt.com";
document.write('<script src="web/js/jquery-2.2.4.js" type="text/javascript" charset="utf-8"><\/script>')
window.onload = function(){
	var text = `<link rel="shortcut icon" href="${url}/web/img/sand_icon.png"/>`;
	// console.log(text)
	$("head").append(text);
};

function getToken() { //调用获取token
